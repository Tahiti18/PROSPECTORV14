  ...
  return (
    <div className="max-w-6xl mx-auto py-8 space-y-12 animate-in fade-in duration-500">
      <div className="flex justify-between items-end border-b border-slate-800/50 pb-8">
        <div>
          <h1 className="text-5xl font-black italic text-white uppercase tracking-tighter">MOTION <span className="text-indigo-600 not-italic">LAB</span></h1>
          <p className="text-[10px] text-slate-500 font-black uppercase tracking-[0.4em] mt-2 italic italic">Cinematic Storyboard Architecture for {lead.businessName}</p>
        </div>
      </div>
           ...
           <div className="bg-[#0b1021] border border-slate-800 rounded-[40px] p-12 shadow-2xl space-y-12">
              <div className="flex justify-between items-start">
                 <div className="space-y-2">
                    <span className="text-[10px] font-black text-indigo-400 uppercase tracking-[0.4em]">TREATMENT: {concept.title}</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                 {concept.scenes.map((scene: any, i: number) => (
                   <div key={i} className="bg-slate-900 border border-slate-800 rounded-3xl p-6 space-y-4 hover:border-indigo-500/40 transition-all group">
                      <div className="flex justify-between items-center">
                         <span className="w-8 h-8 rounded-lg bg-indigo-600/10 flex items-center justify-center font-black text-indigo-400 italic">0{i+1}</span>
                      ...
                      <div className="space-y-3">
                         ...
                         <div className="pt-4 border-t border-slate-800/50">
                            <p className="text-[8px] font-black text-indigo-500 uppercase tracking-widest mb-1">ON-SCREEN TEXT</p>
