          ...
          <div className="bg-[#0b1021] border border-slate-800 rounded-[56px] min-h-[600px] flex flex-col relative shadow-2xl group overflow-hidden">
            {isLoading ? (
               <div className="absolute inset-0 flex flex-col items-center justify-center space-y-6">
                  ...
                  <p className="text-[10px] font-black text-indigo-500 uppercase tracking-widest animate-pulse">ARCHITECTING DEAL STRUCTURE...</p>
               </div>
            ) : proposal ? (
          ...
          <div className="bg-[#0b1021] border border-slate-800 rounded-[56px] p-16 space-y-12 shadow-2xl flex flex-col relative overflow-hidden">
            ...
            <div className="pt-4 flex gap-6 relative z-10">
              <button 
                ...
                className="flex-1 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-20 disabled:cursor-not-allowed text-white py-5 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] shadow-2xl shadow-indigo-600/30 transition-all active:scale-95 border-b-4 border-indigo-700"
              >
