  ...
  return (
    <div className="max-w-4xl mx-auto py-12 space-y-12 animate-in fade-in duration-500">
      ...
      <div className="bg-[#0b1021] border border-slate-800 rounded-[56px] p-16 shadow-2xl space-y-10 relative overflow-hidden">
         <div className="absolute inset-0 opacity-5" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, #4f46e5 1px, transparent 0)', backgroundSize: '48px 48px' }}></div>
         
         <div className="grid grid-cols-1 gap-10 relative z-10">
            <div className="space-y-4">
               <label className="text-[10px] font-black text-indigo-400 uppercase tracking-widest ml-1">Operational Protocol ID</label>
               <input 
                value={protocol}
                onChange={(e) => setProtocol(e.target.value)}
                className="w-full bg-slate-950 border border-slate-800 rounded-2xl px-6 py-5 text-white font-black text-xl focus:outline-none focus:border-indigo-500 transition-all uppercase italic tracking-tighter"
               />
            </div>
            ...
            <div className="space-y-4">
               ...
               <textarea 
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-2xl p-8 text-sm font-bold text-slate-300 focus:outline-none focus:border-indigo-500 h-48 resize-none shadow-xl italic leading-relaxed"
               />
            </div>
            ...
            <div className="pt-6">
               <button 
                 ...
                 className="w-full bg-indigo-600 hover:bg-indigo-500 py-6 rounded-2xl text-[12px] font-black uppercase tracking-[0.4em] text-white transition-all shadow-xl shadow-indigo-600/20 active:scale-95 border border-indigo-400/20"
               >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
         <div className="bg-slate-900/50 border border-slate-800 rounded-[32px] p-10 flex items-center gap-8">
            <div className="w-14 h-14 bg-indigo-600/10 border border-indigo-500/20 rounded-2xl flex items-center justify-center font-black text-indigo-400 text-xl">
               S
            </div>
            <div>
