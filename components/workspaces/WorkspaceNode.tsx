    ...
    <div className="max-w-[1550px] mx-auto py-6 space-y-10 animate-in fade-in duration-700">
      <div className="flex justify-between items-start">
        <div className="space-y-2">
          <h1 className="text-4xl font-black italic text-white uppercase tracking-tighter flex items-center gap-3">
            GEMINI 3 PRO <span className="text-indigo-500 not-italic opacity-40 uppercase tracking-widest">INTELLIGENCE WORKSPACE</span>
        ...
        <div className="bg-indigo-600/10 border border-indigo-500/20 px-6 py-2.5 rounded-full flex items-center gap-3">
           <div className="w-2 h-2 rounded-full bg-indigo-500 shadow-[0_0_10px_rgba(99,102,241,0.5)]"></div>
           <span className="text-[10px] font-black text-indigo-400 uppercase tracking-[0.2em]">REASONING NODE: UNIVERSAL</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
           ...
           <div className="bg-[#0b1021] border border-slate-800 rounded-[48px] p-10 shadow-2xl space-y-10 relative overflow-hidden">
              <div className="space-y-4">
                 ...
                 <select 
                   ...
                   className="w-full bg-[#020617] border border-slate-800 rounded-2xl px-6 py-5 text-sm font-bold text-slate-200 focus:outline-none focus:border-indigo-500 appearance-none cursor-pointer"
                 >
              ...
              <div className="space-y-4">
                 ...
                 <textarea 
                  ...
                  className="w-full bg-[#020617] border border-slate-800 rounded-3xl p-8 text-sm font-medium text-slate-200 focus:outline-none focus:border-indigo-500 h-56 resize-none shadow-inner placeholder-slate-800 italic leading-relaxed"
              ...
              <button 
                ...
                className="w-full bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white py-6 rounded-[24px] text-[12px] font-black uppercase tracking-[0.3em] flex items-center justify-center gap-3 transition-all active:scale-95 shadow-xl shadow-indigo-600/20 border border-indigo-400/20"
              >
        ...
        <div className="lg:col-span-8">
           <div className="bg-white border border-slate-200 rounded-[56px] min-h-[800px] flex flex-col relative shadow-2xl overflow-hidden">
              <div className="p-10 border-b border-slate-100 flex items-center gap-6">
                 ...
                 <div>
                    <h3 className="text-xl font-black italic text-black uppercase tracking-tighter">INTELLIGENCE REPORT</h3>
              ...
              <div className="flex-1 p-16 relative overflow-y-auto custom-scrollbar-light">
                 {isProcessing ? (
                   ...
                   <div className="h-full flex flex-col items-center justify-center text-center opacity-20 py-20">
                      <div className="w-32 h-32 border-4 border-slate-100 rounded-full flex items-center justify-center mb-8">
