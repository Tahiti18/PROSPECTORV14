    ...
    <div className="max-w-[1550px] mx-auto py-12 space-y-12 animate-in fade-in duration-700">
      ...
      {isLoading ? (
        <div className="min-h-[600px] flex flex-col items-center justify-center space-y-12 py-20">
           ...
           <p className="text-[12px] font-black text-indigo-500 uppercase tracking-[0.7em] animate-pulse italic">EXTRACTING HYPER-FIDELITY INTEL...</p>
        </div>
      ) : report ? (
        <div className="space-y-20 animate-in slide-in-from-bottom-8 duration-700">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
             ...
             <div className="lg:col-span-5 space-y-10">
                <div className="bg-indigo-600 p-12 rounded-[48px] shadow-2xl space-y-6 relative overflow-hidden group">
                ...
                <div className="space-y-8">
                   ...
                   <div className="grid grid-cols-1 gap-4">
                      {report.sources.map((s, i) => (
                         <a key={i} href={s.uri} target="_blank" rel="noopener noreferrer" className="p-6 bg-slate-50 border border-slate-100 rounded-[28px] hover:border-indigo-500/30 transition-all group flex flex-col gap-1 shadow-sm">
                            <p className="text-[11px] font-black text-slate-800 uppercase truncate group-hover:text-indigo-500 transition-colors">{s.title}</p>
