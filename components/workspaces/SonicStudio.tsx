...
export const SonicStudio: React.FC<SonicStudioProps> = ({ lead }) => {
  ...
  const handleGenerateMusic = async () => {
    ...
    try {
        // Run full cycle: Generates, Polls, and Saves to Assets
        ...
        // Explicitly refresh assets to ensure UI update, although subscription should handle it
        const allAssets = SESSION_ASSETS; 
