...
export const SonicStudio: React.FC<SonicStudioProps> = ({ lead }) => {
  ...
  useEffect(() => {
    if (lead) {
        setText(lead.personalizedHook || `Hello ${lead.businessName}, I see a huge opportunity to dominate the ${lead.city} market with AI video automation. Let's chat.`);
    }
  }, [lead?.id]);
