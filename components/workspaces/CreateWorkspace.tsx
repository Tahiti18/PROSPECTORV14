  ...
  return (
    <div className="space-y-12 py-12 max-w-[1550px] mx-auto px-6 animate-in fade-in duration-700">
      <div className="flex items-end justify-between">
        ...
        <div className="text-[11px] font-black text-indigo-400 uppercase tracking-[0.3em] border-2 border-indigo-500/20 px-8 py-4 rounded-[24px] bg-indigo-500/5 shadow-2xl">
          ...
          <div className="bg-[#0b1021] border border-slate-800 rounded-[56px] p-12 shadow-2xl space-y-10 relative overflow-hidden">
            ...
            <div className="space-y-4 relative z-10">
              ...
              <div className="bg-[#020617] border border-slate-800 rounded-[28px] p-2">
                 <select className="w-full bg-transparent border-none px-6 py-4 text-sm font-black text-indigo-400 focus:ring-0 appearance-none cursor-pointer uppercase italic">
            ...
            <div className="space-y-4 relative z-10">
              ...
              <textarea 
                className="w-full bg-[#020617] border border-slate-800 rounded-[32px] p-8 text-sm font-bold text-slate-300 focus:outline-none focus:border-indigo-500 h-64 resize-none shadow-xl placeholder-slate-800 italic leading-relaxed"
                placeholder="INPUT OPERATIONAL DIRECTIVES FOR THE NEURAL CORE..."
              />
            </div>
            
            <button className="w-full bg-indigo-600 hover:bg-indigo-500 text-white py-6 rounded-[28px] text-[12px] font-black uppercase tracking-[0.3em] transition-all shadow-xl shadow-indigo-600/20 active:scale-95 border-b-4 border-indigo-700">
             ...
             <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex justify-between items-center py-2 border-b border-slate-800 last:border-0">
                     ...
                     <span className="text-[10px] font-black text-indigo-400 italic">{spec.v}</span>
                  </div>
                ))}
             </div>
          </div>
          ...
          <div className="bg-[#05091a]/40 border border-slate-800 border-dashed rounded-[84px] h-full min-h-[700px] flex flex-col items-center justify-center group relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col items-center text-center space-y-8 px-20">
               ...
               <div className="space-y-4">
                  ...
                  <p className="text-[11px] font-black text-slate-600 uppercase tracking-[0.6em] max-w-sm mx-auto leading-relaxed group-hover:text-indigo-400/60 transition-colors">
            ...
            {/* Pro corner styling */}
            <div className="absolute top-16 left-16 w-12 h-12 border-t-4 border-l-4 border-slate-800/50 group-hover:border-indigo-500/30 transition-colors"></div>
            <div className="absolute bottom-16 right-16 w-12 h-12 border-b-4 border-r-4 border-slate-800/50 group-hover:border-indigo-500/30 transition-colors"></div>
          </div>
        </div>
      </div>
    </div>
