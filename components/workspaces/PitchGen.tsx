  ...
  return (
    <div className="max-w-4xl mx-auto py-8 space-y-12 animate-in fade-in duration-500">
      <div className="text-center">
        <h1 className="text-4xl font-black italic text-white uppercase tracking-tighter">PITCH <span className="text-emerald-600 not-italic">GEN</span></h1>
         ...
         {isLoading ? (
           ...
           <div className="animate-in slide-in-from-bottom-4 duration-700">
              <div className="bg-[#020617] border border-slate-800 p-12 rounded-[40px] text-center space-y-8 relative">
                 <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-emerald-600 px-4 py-1 rounded text-[8px] font-black text-white uppercase tracking-widest">30S_DEPLOYMENT_SCRIPT</div>
              ...
              <div className="mt-12 flex justify-center gap-6">
                 ...
                 <button className="bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl transition-all">COPY TO CLIPBOARD</button>
              </div>
           </div>
         )}
      </div>
