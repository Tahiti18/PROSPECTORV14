        ...
        <div className="bg-[#0b1021] border border-slate-800 rounded-[40px] p-12 shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-8">
            <div className="space-y-3">
               ...
               <input type="number" value={roiState.ltv} onChange={e => setRoiState({...roiState, ltv: parseInt(e.target.value) || 0})} className="w-full bg-slate-950 border border-slate-800 rounded-xl px-5 py-4 text-white font-black text-xl focus:outline-none focus:border-emerald-500 transition-colors" />
            </div>
            <div className="space-y-3">
               <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Monthly Lead Volume</label>
               <input type="number" value={roiState.leads} onChange={e => setRoiState({...roiState, leads: parseInt(e.target.value) || 0})} className="w-full bg-slate-950 border border-slate-800 rounded-xl px-5 py-4 text-white font-black text-xl focus:outline-none focus:border-emerald-500 transition-colors" />
            </div>
            <div className="space-y-3">
          ...
          <div className="bg-[#05091a] rounded-[32px] border border-slate-800/60 p-10 flex flex-col items-center justify-center text-center space-y-2">
             ...
             <button className="mt-8 bg-emerald-600/10 border border-emerald-500/20 text-emerald-400 px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-emerald-600 hover:text-white transition-all">GENERATE REPORT</button>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="max-w-5xl mx-auto py-12 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
         <div className="bg-[#0b1021] border border-slate-800 rounded-[40px] p-10 space-y-6 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-600/5 blur-[50px] rounded-full"></div>
            <h3 className="text-sm font-black text-white uppercase tracking-widest border-b border-slate-800 pb-4">System Protocols</h3>
            {[1,2,3].map(i => (
         ...
         <div className="bg-[#0b1021] border border-slate-800 rounded-[40px] p-10 space-y-6 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-600/5 blur-[50px] rounded-full"></div>
            <h3 className="text-sm font-black text-white uppercase tracking-widest border-b border-slate-800 pb-4">Live Diagnostics</h3>
      ...
      <div className="bg-[#05091a] border border-slate-800 rounded-[32px] p-12 text-center opacity-60">
