          ...
          <div className="bg-[#0b1021] border border-slate-800 rounded-[32px] p-8 space-y-6 shadow-2xl">
            <div className="space-y-2">
               ...
               <select 
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-[10px] font-black text-slate-300 focus:outline-none focus:border-indigo-500 uppercase tracking-widest"
               >
        ...
        <div className="lg:col-span-8 bg-[#05091a] border border-slate-800 rounded-[48px] p-12 min-h-[500px] relative overflow-hidden shadow-2xl">
           {isLoading ? (
             <div className="absolute inset-0 flex flex-col items-center justify-center space-y-6">
                ...
                <p className="text-[10px] font-black text-indigo-400 uppercase tracking-[0.3em] animate-pulse">Request Routing via Neural Mesh...</p>
             </div>
           ) : response ? (
